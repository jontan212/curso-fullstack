...
class PanelAccion extends JPanel {
	public PanelAccion() {
		AccionColor accionAmarillo = new AccionColor("Amarillo", new ImageIcon("src/graficos/bola_amarilla.png"),
				Color.YELLOW);
		...
		/*
		 * El parámetro indica que el objeto que va a recibir el foco(el botón) está
	...
	private class AccionColor extends AbstractAction {
		public AccionColor(String nombre, Icon icono, Color color_boton) {
			/* Les pasá la variable y su valor */
		...
		public void actionPerformed(ActionEvent e) {
			/* Con el get se recupera el valor */

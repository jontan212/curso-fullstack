...
try {
	...
	.getConnection("jdbc:mysql://localhost:3306/proyecto_jsp?autoReconnect=true&useSSL=false", "root", "");
...
<body>
	<table border="1">
		...
		<c:forEach var="empTemp" items="${losEmpleados}">
			<tr>
				<%-- <td>${empTemp.nombre}</td><td>${empTemp.apellido}</td> --%>
				<%-- <td>${empTemp.puesto}</td><td>${empTemp.salario}</td> --%>
				<!-- <td> -->
